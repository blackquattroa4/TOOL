...
"":this.value;b!=e.sSearch&&(ga(a,{sSearch:b,bRegex:e.bRegex,bSmart:e.bSmart,bCaseInsensitive:e.bCaseInsensitive}),a._iDisplayStart=0,O(a))},g=null!==a.searchDelay?a.searchDelay:"ssp"===y(a)?400:0,i=h("input",b).val(e.sSearch).attr("title",d.sSearchTitle).attr("placeholder",d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT",g?Qa(f,g):f).on("keypress.DT",function(a){if(13==a.keyCode)return!1}).attr("aria-controls",c);h(a.nTable).on("search.dt.DT",function(b,c){if(a===c)try{i[0]!==H.activeElement&&i.val(e.sSearch)}catch(d){}});
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"&#9193;",sPrevious:"&#9194;"},sEmptyTable:"No data available in table",sInfo:" _START_ ~ _END_ / _TOTAL_ ",sInfoEmpty:" 0 ~ 0 / 0 ",sInfoFiltered:"/ _MAX_ ",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:" _MENU_ &#9776;",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"&#128269",sSearchPlaceholder:"",sSearchTitle:"",sUrl:"",sZeroRecords:"&#8709;"},
