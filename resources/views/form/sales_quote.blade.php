				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" method="POST" action="{{ $source['post_url'] }}">
						...
						<div v-for="(line, index) in form.line" class="form-group detail-line">
							...
							<input id="discount[]" type="hidden" name="discount[]" v-model="form.discount[index]" ></input>
...
@section('post-content')
	...
	@if (!$readonly)
		...
		function fillDefaultValue(index) {
			...
			vueContainer.form.unitprice[index] = dataSource.extended_product_option[pid]["unitprice"];
		}
	@endif
