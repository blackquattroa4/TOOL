	    ...
	    <div class="col-md-10 col-md-offset-1">
            <div id="rowwindow" class="panel panel-default">
                <div class="panel-heading">
					<table width='100%'>
						<tr>
							<td><h4>{{ trans('tool.Edit Role') }}</h4></td>
							<td></td>
						</tr>
					</table>
				</div>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-12">
							<div class="form-group{{ $errors->has('permission') ? ' has-error' : '' }}">
								...
								<div class="col-md-12">
									{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => 'name', 'style' => 'width:25px;height:25px;')) }}
						...
						<div class="col-xs-12 col-sm-12 col-md-12 text-center">
							<button type="submit" class="btn btn-primary pull-right">{{ trans('forms.Update') }}</button>
						</div>
					</div>
					{!! Form::close() !!}
				</div>
