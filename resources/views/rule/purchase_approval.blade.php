		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4>{{ trans('forms.Purchase approval rule') }}</h4>
				</div>
					...
					<form class="form-horizontal" role="form" method="POST" action="">
						...
						<div v-for="(id, index) in form.line" class="form-group detail-line">
							...
							<div class="col-md-1" v-bind:class="{ 'has-error' : 'order.'+index in errors }">
								...
								<input id="_order[]" type="checkbox" class="form-control" name="order[]" v-model="form.order[index]" {{ $readonly ? "disabled" : "" }}>
